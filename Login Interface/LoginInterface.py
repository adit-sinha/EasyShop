...
welc = Label(choicepg, text = "Welcome to EasyShop's Shopping Interface!", font = ('Century Gothic',15), background = '#33f5eb') 
...
result = Label(choicepg, background = '#33f5eb') #Label used to tell user username already exists
ortext = Label(choicepg, text = "OR", font = ('Century Gothic',15), background = '#33f5eb')
