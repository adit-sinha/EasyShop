...
def logf():
    ...
    def mainent():
        if Login.get() in logpwdic:
            ...
            Result['text'] = 'Try Again!'
    #Buttons        
    welc = Label(logpg, text = "Please login to your EasyShop Account:", font = ('Century Gothic',15), background = '#5ee682')
    ...
    Result = Label(logpg, background = '#5ee682')
